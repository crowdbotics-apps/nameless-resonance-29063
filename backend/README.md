...
## Project Structure
    ...
    ├── nameless_resonance_29063  # Django project configurations
...
1. Clone this repo and `cd nameless_resonance_29063`
...
2. Clone this repo and `cd nameless_resonance_29063`
